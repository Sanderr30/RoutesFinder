...
void HelpCommand::ExecuteCmd(const std::string& command
                                , ConfigVariables& cfg)
{
    if (command == "--help") {
...
void QuitCommand::ExecuteCmd(const std::string& command
                            , ConfigVariables& cfg)
{
    if (command == "--quit") {
...
void DepartureTownCommand::ExecuteCmd(const std::string& command
                                    , ConfigVariables& cfg)
{
...
void ArrivalTownCommand::ExecuteCmd (const std::string& command
                                    , ConfigVariables& cfg)
{
...
void DateCommand::ExecuteCmd(const std::string& command
                            , ConfigVariables& cfg)
{
...
void ShowConfigCommand::ExecuteCmd(const std::string& command
                                    , ConfigVariables& cfg)
{
    if (command == "--show") {
